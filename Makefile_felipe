...
MYLIBSOURCES = mygraphlib.cpp geompack.cpp myutils.cpp prizecollectingpath_ilp.cpp 
MYOBJLIB = $(MYLIBSOURCES:.cpp=.o)

#ex_ad_allocation.cpp
#EX = ex_basics_graph.cpp ex_fractional_packing.cpp ex_knapsack.cpp ex_tsp_gurobi.cpp  generate_random_euclidean_graph.cpp generate_triangulated_digraph.cpp generate_triangulated_graph.cpp ex_steiner-directed_gurobi.cpp generate_steiner_file.cpp ex_kpaths.cpp ex_cflp.cpp ex_bipartite_matching.cpp ex_bipartite_matching2.cpp ex_perfect_matching_general_graphs.cpp ex_two_matching.cpp 
#EX = knapsack.cpp knapsack_bt_bnb.cpp 
EX = prizecollectingpath.cpp
OBJEX = $(EX:.cpp=.o)
